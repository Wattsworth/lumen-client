    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function processData() {
            ...
            for (i = 0; i < series.length; ++i) {
                s = series[i];
                if (s.events.show){
                    continue; //do not process events like time series data
                }
                data = s.data;
        ...
        function insertLegend() {
            ...
            for (var i = 0; i < series.length; ++i) {
                ...
                if (s.label) {
                    ...
                    if (label && s.yaxis.n!=5) { //events are on the y axis 5
                        ...
                        if(s.yaxis.n==3||s.yaxis.n==4){
                            label+=svg_exclamation_triangle;
                        }
