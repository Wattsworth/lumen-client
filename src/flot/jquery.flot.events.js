...
(function ($) {
            ...
            function(plot, ctx, series) {
                ...
                series.data
                  .map(event=>{
                    ...
                    ctx.restore();*/
                    let marker_data = computeMarker(series.events.settings.marker, event);
                    //shrink the svg to roughly 10x10 then apply the scaling factor
                    //Compensate the scale factor and offset by icon specific values
                    ctx.translate(box[0]+box[2]/2-marker_px/2+marker_data['x-offset'],box[1]+box[3]/2-marker_px/2+marker_data['y-offset']);
                    let marker_scale = series.events.settings.marker.size/10 * marker_data['scale'];
                    ctx.scale(0.02*marker_scale,0.02*marker_scale);
                    ctx.fill(new Path2D(marker_data['path']));
                    ctx.restore();
                    ...
                    if(event.selected){
                        ...
                        ctx.shadowColor = '#444'
                        ctx.shadowBlur =6;
                        ctx.fill(new Path2D(svg_check['path']));
                        ctx.restore();
                    }
    ...
    //regular cirle
    svg_circle = {'path': "M 256 8 C 119 8 8 119 8 256 s 111 248 248 248 s 248 -111 248 -248 S 393 8 256 8 Z m 0 448 c -110.5 0 -200 -89.5 -200 -200 S 145.5 56 256 56 s 200 89.5 200 200 s -89.5 200 -200 200 Z",
                  'x-offset': 0,
                  'y-offset': 0,
                  'scale': 1.0}
    //circle
    svg_dot = {'path': "M 256 8 C 119 8 8 119 8 256 s 111 248 248 248 s 248 -111 248 -248 S 393 8 256 8 Z",
                'x-offset': 0,
                'y-offset': 0,
                'scale': 1.0}
    //plus
    svg_plus = {'path': "M 416 208 H 272 V 64 c 0 -17.67 -14.33 -32 -32 -32 h -32 c -17.67 0 -32 14.33 -32 32 v 144 H 32 c -17.67 0 -32 14.33 -32 32 v 32 c 0 17.67 14.33 32 32 32 h 144 v 144 c 0 17.67 14.33 32 32 32 h 32 c 17.67 0 32 -14.33 32 -32 V 304 h 144 c 17.67 0 32 -14.33 32 -32 v -32 c 0 -17.67 -14.33 -32 -32 -32 Z",
                'x-offset': 1,
                'y-offset': -1,
                'scale': 1.0}
    //star-of-life
    svg_asterix   = {'path': "M 259.3 17.8 L 194 150.2 L 47.9 171.5 c -26.2 3.8 -36.7 36.1 -17.7 54.6 l 105.7 103 l -25 145.5 c -4.5 26.3 23.2 46 46.4 33.7 L 288 439.6 l 130.7 68.7 c 23.2 12.2 50.9 -7.4 46.4 -33.7 l -25 -145.5 l 105.7 -103 c 19 -18.5 8.5 -50.8 -17.7 -54.6 L 382 150.2 L 316.7 17.8 c -11.7 -23.6 -45.6 -23.9 -57.4 0 Z",
                     'x-offset': -1,
                     'y-offset': -1,
                     'scale': 1.0}
    //times
    svg_cross = {'path': "M 242.72 256 l 100.07 -100.07 c 12.28 -12.28 12.28 -32.19 0 -44.48 l -22.24 -22.24 c -12.28 -12.28 -32.19 -12.28 -44.48 0 L 176 189.28 L 75.93 89.21 c -12.28 -12.28 -32.19 -12.28 -44.48 0 L 9.21 111.45 c -12.28 12.28 -12.28 32.19 0 44.48 L 109.28 256 L 9.21 356.07 c -12.28 12.28 -12.28 32.19 0 44.48 l 22.24 22.24 c 12.28 12.28 32.2 12.28 44.48 0 L 176 322.72 l 100.07 100.07 c 12.28 12.28 32.2 12.28 44.48 0 l 22.24 -22.24 c 12.28 -12.28 12.28 -32.19 0 -44.48 L 242.72 256 Z",
                 'x-offset': 2,
                 'y-offset': 0,
                 'scale': 1.0}
    //ruler-vertical
    svg_vertical_line = {'path': "M 168 416 c -4.42 0 -8 -3.58 -8 -8 v -16 c 0 -4.42 3.58 -8 8 -8 h 88 v -64 h -88 c -4.42 0 -8 -3.58 -8 -8 v -16 c 0 -4.42 3.58 -8 8 -8 h 88 v -64 h -88 c -4.42 0 -8 -3.58 -8 -8 v -16 c 0 -4.42 3.58 -8 8 -8 h 88 v -64 h -88 c -4.42 0 -8 -3.58 -8 -8 v -16 c 0 -4.42 3.58 -8 8 -8 h 88 V 32 c 0 -17.67 -14.33 -32 -32 -32 H 32 C 14.33 0 0 14.33 0 32 v 448 c 0 17.67 14.33 32 32 32 h 192 c 17.67 0 32 -14.33 32 -32 v -64 h -88 Z",
                         'x-offset': 3,
                         'y-offset': 0,
                         'scale': 1.0}
    //ruler-horizontal
    svg_horizontal_line = {'path': "M 544 128 h -48 v 88 c 0 4.42 -3.58 8 -8 8 h -16 c -4.42 0 -8 -3.58 -8 -8 v -88 h -64 v 88 c 0 4.42 -3.58 8 -8 8 h -16 c -4.42 0 -8 -3.58 -8 -8 v -88 h -64 v 88 c 0 4.42 -3.58 8 -8 8 h -16 c -4.42 0 -8 -3.58 -8 -8 v -88 h -64 v 88 c 0 4.42 -3.58 8 -8 8 h -16 c -4.42 0 -8 -3.58 -8 -8 v -88 h -64 v 88 c 0 4.42 -3.58 8 -8 8 H 88 c -4.42 0 -8 -3.58 -8 -8 v -88 H 32 c -17.67 0 -32 14.33 -32 32 v 192 c 0 17.67 14.33 32 32 32 h 512 c 17.67 0 32 -14.33 32 -32 V 160 c 0 -17.67 -14.33 -32 -32 -32 Z",
                           'x-offset': -1,
                           'y-offset': 0,
                           'scale': 1.0}
    //square
    svg_square ={'path':  "M 471.99 334.43 L 336.06 256 l 135.93 -78.43 c 7.66 -4.42 10.28 -14.2 5.86 -21.86 l -32.02 -55.43 c -4.42 -7.65 -14.21 -10.28 -21.87 -5.86 l -135.93 78.43 V 16 c 0 -8.84 -7.17 -16 -16.01 -16 h -64.04 c -8.84 0 -16.01 7.16 -16.01 16 v 156.86 L 56.04 94.43 c -7.66 -4.42 -17.45 -1.79 -21.87 5.86 L 2.15 155.71 c -4.42 7.65 -1.8 17.44 5.86 21.86 L 143.94 256 L 8.01 334.43 c -7.66 4.42 -10.28 14.21 -5.86 21.86 l 32.02 55.43 c 4.42 7.65 14.21 10.27 21.87 5.86 l 135.93 -78.43 V 496 c 0 8.84 7.17 16 16.01 16 h 64.04 c 8.84 0 16.01 -7.16 16.01 -16 V 339.14 l 135.93 78.43 c 7.66 4.42 17.45 1.8 21.87 -5.86 l 32.02 -55.43 c 4.42 -7.65 1.8 -17.43 -5.86 -21.85 Z",
                 'x-offset': 0,
                 'y-offset': 0,
                 'scale': 1.0}    
    //ankh
    svg_diamond = {'path': "M 296 256 h -44.62 C 272.46 222.01 288 181.65 288 144 C 288 55.63 230.69 0 160 0 S 32 55.63 32 144 c 0 37.65 15.54 78.01 36.62 112 H 24 c -13.25 0 -24 10.74 -24 24 v 32 c 0 13.25 10.75 24 24 24 h 96 v 152 c 0 13.25 10.75 24 24 24 h 32 c 13.25 0 24 -10.75 24 -24 V 336 h 96 c 13.25 0 24 -10.75 24 -24 v -32 c 0 -13.26 -10.75 -24 -24 -24 Z M 160 80 c 29.61 0 48 24.52 48 64 c 0 34.66 -27.14 78.14 -48 100.87 c -20.86 -22.72 -48 -66.21 -48 -100.87 c 0 -39.48 18.39 -64 48 -64 Z",
                   'x-offset': 2,
                   'y-offset': 0,
                   'scale': 1.0}
    //caret-up
    svg_upward_triangle = {'path': "M 288.662 352 H 31.338 c -17.818 0 -26.741 -21.543 -14.142 -34.142 l 128.662 -128.662 c 7.81 -7.81 20.474 -7.81 28.284 0 l 128.662 128.662 c 12.6 12.599 3.676 34.142 -14.142 34.142 Z",
                           'x-offset': 0,
                           'y-offset': -5,
                           'scale': 1.7}
    //caret-down
    svg_downward_triangle = {'path': "M 31.3 192 h 257.3 c 17.8 0 26.7 21.5 14.1 34.1 L 174.1 354.8 c -7.8 7.8 -20.5 7.8 -28.3 0 L 17.2 226.1 C 4.6 213.5 13.5 192 31.3 192 Z",
                             'x-offset': 0,
                             'y-offset': -5,
                             'scale': 1.7}
    //carent-left
    svg_leftward_triangle = {'path': "M 192 127.338 v 257.324 c 0 17.818 -21.543 26.741 -34.142 14.142 L 29.196 270.142 c -7.81 -7.81 -7.81 -20.474 0 -28.284 l 128.662 -128.662 c 12.599 -12.6 34.142 -3.676 34.142 14.142 Z",
                             'x-offset': 2,
                             'y-offset': -3,
                             'scale': 1.5}
    //caret-right
    svg_rightward_triangle = {'path': "M 0 384.662 V 127.338 c 0 -17.818 21.543 -26.741 34.142 -14.142 l 128.662 128.662 c 7.81 7.81 7.81 20.474 0 28.284 L 34.142 398.804 C 21.543 411.404 0 402.48 0 384.662 Z",
                              'x-offset': 4,
                              'y-offset': -3,
                              'scale': 1.5}
    //adjust
    svg_pentagram = {'path': "M 8 256 c 0 136.966 111.033 248 248 248 s 248 -111.034 248 -248 S 392.966 8 256 8 S 8 119.033 8 256 Z m 248 184 V 72 c 101.705 0 184 82.311 184 184 c 0 101.705 -82.311 184 -184 184 Z",
                     'x-offset': 0,
                     'y-offset': 0,
                     'scale': 1.0}
    //ban
    svg_hexagram = {'path': "M 256 8 C 119.034 8 8 119.033 8 256 s 111.034 248 248 248 s 248 -111.034 248 -248 S 392.967 8 256 8 Z m 130.108 117.892 c 65.448 65.448 70 165.481 20.677 235.637 L 150.47 105.216 c 70.204 -49.356 170.226 -44.735 235.638 20.676 Z M 125.892 386.108 c -65.448 -65.448 -70 -165.481 -20.677 -235.637 L 361.53 406.784 c -70.203 49.356 -170.226 44.736 -235.638 -20.676 Z",
                    'x-offset': 0,
                    'y-offset': 0,
                    'scale': 1.0}
    //check (for selected events)
    svg_check = {'path': "M470.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L192 338.7 425.4 105.4c12.5-12.5 32.8-12.5 45.3 0z",
                 'x-offset': 0,
                 'y-offset': 0,
                 'scale': 1.0}
